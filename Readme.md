...
**Cevap:** ben grafiği tam çizemedim  anlamadım

c) Elle çizdiğiniz grafik orijinden geçmiyor.  *x=0* iken *y=0* değil. *x=0* iken *y* nedir? Sizce neden orjinden geçmiyor?
**Cevap:** çünkü bir kuvvet uyguladığımızda karşılığında zır yönde bir kuvvet alıyoruz.
...
**Cevap**: (Soldaki), (Ortadaki), (Sağdaki) (Sağdakine 😊)
...
**Cevap**: videodan tam oalrak nasıl çizeceğimi anlamadım.)
